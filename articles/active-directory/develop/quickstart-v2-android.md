...
Applications must be represented by an app object in Azure Active Directory so that the Microsoft identity platform can rrovide
tokens your application.
